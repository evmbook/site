...
| **Olympia** | TBD | 2025 | EIP-1559 with treasury, ECIP-1121 opcodes |
...
| **Pectra** | TBD | Late 2024 | EIP-7702 (native AA), EIP-7251, EIP-7002 |
...
| — | Olympia | EIP-1559 with treasury (not burn), opcode alignment |

<Note>
ETC generally implements EVM-related EIPs while skipping consensus-related changes that assume Proof of Stake. The Olympia upgrade is notable for implementing EIP-1559 semantics but with a different economic model: base fees go to a treasury for protocol development rather than being burned.
</Note>
