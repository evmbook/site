      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="absolute inset-0 -z-10">
            <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-neon-pink/10 rounded-full blur-3xl" />
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/download"
              className="inline-flex items-center justify-center rounded-lg bg-transparent border border-neon-cyan px-6 py-3 text-base font-semibold text-neon-cyan hover:bg-neon-cyan/10 shadow-md shadow-neon-cyan/10 hover:shadow-lg hover:shadow-neon-cyan/25 transition-all duration-200"
            >
              <svg className="mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
