...
export default function CodeLibraryPage() {
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <div className="not-prose flex items-center gap-4 text-sm mb-8">
      ...
      <pre className="not-prose bg-[var(--surface-base)] p-4 text-sm overflow-x-auto font-mono text-[var(--text-secondary)] border-4 border-[var(--accent-tertiary)]/30">
{`# Install Foundry
